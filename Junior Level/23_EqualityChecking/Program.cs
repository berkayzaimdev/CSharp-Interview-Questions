...
class Program
{
    static void Main(string[] args)
    {
        ...
        // == operatörü struct'larda override edilmediği müddetçe çalışmaz.
...
/*
 * Karşılaştırma işlemi, referans bazlıdır. Yani class gibi referans tipli değişkenlerde override edilmediği sürece yanlış çalışır.
 * Equals için de, == operatörü için de referans bazlı çalışır. Bunu değişirmek için Equals metodunu override edebiliriz.
 */

...
/*
 * Buradaki temel felsefe, sabit sayılardan mümkün olduğunca parametreler ve provider, helper vs. gibi sınıfları kullanarak faydalanmalıyız.
 * Vergi oranını tam sayı şekilde girdiğimizi düşünelim. Olası bir ekonomik politika değişikliğinde vergi oranı da değişecektir.
 * Bu vergi oranı değişikliği sonucu kodumuzda o oranın geçtiği her satırı tek tek değiştirmek yerine, provider'daki vergi oranı parametresini değiştirerek bu sorundan kurtulabiliriz.
 */
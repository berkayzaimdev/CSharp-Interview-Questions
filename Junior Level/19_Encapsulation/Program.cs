...
/*
 * Encapsulation, bir NYP prensibidir ve class'lardaki parametrelerin private ile gizlenmesi demektir.
 * Data hiding ise Encapsulation'a çok benzeyen fakat aslında ayrı olan bir prensiptir
 * 
 * 
 * Encapsulation'un getirdiği avantajlar;
 *    - Kodu daha tutarlı hale getirir
 *    - Kod tekrarından kurtarır
 *    - Kodu daha kolay değiştirilebilir kılar
 *    - 
 */